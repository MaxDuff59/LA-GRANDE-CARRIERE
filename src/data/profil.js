...
export const NATIONS = [
  ...
  },
  {
    ...
    flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿",
    tier: 1,
    desc: "La Premiership est un vivier sans fond. Difficile de percer.",
    mod: { puissance: 5, mental: 5 },
    selecDiff: 1.3,
  },
  {
    id: "ar",
...
export const ORIGINES = [
  ...
  },
  {
    ...
    mod: { puissance: 7, mental: 10, technique: -3 },
    argent: 0,
    hype: -5,
  },
  {
    id: "reconversion",
    nom: "Reconversion athlétique",
    desc: "Sprinteur avant. Rugby découvert à 17 ans.",
    mod: { vitesse: 17, endurance: 7, technique: -13, vision: -10 },
    argent: 0,
    hype: 0,
  },
  {
    id: "fils",
    nom: "Fils de joueur pro",
    desc: "Le nom ouvre des portes. Et attire les regards.",
    mod: { vision: 10, mental: -7 },
    argent: 40,
    hype: 20,
  },
  {
    id: "iles",
    nom: "Filière îles du Pacifique",
    desc: "Arrivé à 18 ans, sans repères, avec le feu.",
    mod: { puissance: 7, vitesse: 10, mental: 10, vision: -7 },
    argent: -10,
    hype: 5,
  },
];
