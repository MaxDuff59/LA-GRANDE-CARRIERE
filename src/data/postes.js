 ...
 *
 * base       : attributs de départ à 18 ans, sur 100 (voir progression.js
 *              pour la montée en puissance ; 100 est très difficile et
 *              ne s'atteint jamais avant 27-28 ans)
...
export const POSTES = [
  {
    ...
    base: { puissance: 53, vitesse: 20, technique: 27, vision: 23, mental: 37, endurance: 40 },
    usure: 1.55,
    essaiRate: 0.10,
  ...
  },
  {
    ...
    base: { puissance: 47, vitesse: 27, technique: 40, vision: 30, mental: 37, endurance: 40 },
    usure: 1.45,
    essaiRate: 0.16,
  ...
  },
  {
    ...
    base: { puissance: 50, vitesse: 23, technique: 30, vision: 27, mental: 33, endurance: 43 },
    usure: 1.40,
    essaiRate: 0.13,
  ...
  },
  {
    ...
    base: { puissance: 43, vitesse: 37, technique: 33, vision: 33, mental: 40, endurance: 43 },
    usure: 1.35,
    essaiRate: 0.22,
  ...
  },
  {
    ...
    base: { puissance: 47, vitesse: 33, technique: 37, vision: 40, mental: 40, endurance: 43 },
    usure: 1.30,
    essaiRate: 0.26,
  ...
  },
  {
    ...
    base: { puissance: 23, vitesse: 43, technique: 47, vision: 50, mental: 43, endurance: 40 },
    usure: 1.10,
    essaiRate: 0.24,
  ...
  },
  {
    ...
    base: { puissance: 23, vitesse: 37, technique: 50, vision: 53, mental: 40, endurance: 37 },
    usure: 1.05,
    essaiRate: 0.18,
    buteur: true,
  ...
  },
  {
    ...
    base: { puissance: 40, vitesse: 40, technique: 37, vision: 40, mental: 37, endurance: 40 },
    usure: 1.25,
    essaiRate: 0.30,
  ...
  },
  {
    ...
    base: { puissance: 30, vitesse: 57, technique: 37, vision: 33, mental: 33, endurance: 37 },
    usure: 1.00,
    essaiRate: 0.52,
  ...
  },
  {
    ...
    base: { puissance: 30, vitesse: 47, technique: 43, vision: 47, mental: 40, endurance: 40 },
    usure: 1.05,
    essaiRate: 0.34,
    buteur: true,
